...
class Venta extends Conexion{
    ...
    public function factura($id){
        $sql = "SELECT detalle_id, venta_fecha, cliente_nombre, cliente_nit, producto_nombre, producto_precio, detalle_cantidad, (producto_precio * detalle_cantidad) as total from ventas inner join clientes on venta_cliente = cliente_id  
         INNER JOIN detalle_ventas ON venta_id = detalle_venta
         INNER JOIN productos ON detalle_producto = producto_id
